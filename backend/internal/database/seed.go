...
func Seed(db *gorm.DB) error {
	...
	books := []model.Book{
		...
		{Entity: model.Entity{ID: 2}, Name: "Children Of Iron", Author: "Nikki Wolf", ISBN: "7665438976", PublisherID: 16, BookTypeID: 1, GenreID: 11, ConditionID: 6, Price: 13.95, Quantity: 3},
		{Entity: model.Entity{ID: 3}, Name: "Gold In The Dark", Author: "Richard Roe", ISBN: "5442280765", PublisherID: 17, BookTypeID: 1, GenreID: 13, ConditionID: 5, Price: 6.50, Quantity: 10},
		{Entity: model.Entity{ID: 4}, Name: "Leagues Of Smoke", Author: "Pat Candella", ISBN: "4556789542", PublisherID: 18, BookTypeID: 2, GenreID: 11, ConditionID: 7, Price: 3.00, Quantity: 1},
		{Entity: model.Entity{ID: 5}, Name: "Alone With The Stars", Author: "Carlos Salazar", ISBN: "4563358087", PublisherID: 19, BookTypeID: 2, GenreID: 12, ConditionID: 5, Price: 15.95, Quantity: 5},
		{Entity: model.Entity{ID: 6}, Name: "The Girl In The Polaroid", Author: "Terri Whitlock", ISBN: "2354435678", PublisherID: 20, BookTypeID: 1, GenreID: 12, ConditionID: 6, Price: 8.25, Quantity: 2},
		{Entity: model.Entity{ID: 7}, Name: "1001 Jokes", Author: "Mary Major", ISBN: "6554789632", PublisherID: 21, BookTypeID: 2, GenreID: 11, ConditionID: 5, Price: 13.95, Quantity: 7},
		{Entity: model.Entity{ID: 8}, Name: "My Search For Meaning", Author: "Mateo Jackson", ISBN: "4558786554", PublisherID: 22, BookTypeID: 3, GenreID: 8, ConditionID: 7, Price: 5.00, Quantity: 15},
	}
