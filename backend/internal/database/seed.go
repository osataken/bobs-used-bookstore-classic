...
func Seed(db *gorm.DB) error {
	...
	referenceData := []model.ReferenceDataItem{
		...
		// Publisher (DataType=0), IDs 15-24
	...
	for i := range referenceData {
		if err := db.Create(&referenceData[i]).Error; err != nil {
			return err
		}
	}
	...
	books := []model.Book{
		{Entity: model.Entity{ID: 1}, Name: "2020: The Apocalypse", Author: "Li Juan", ISBN: "6556784356", PublisherID: 15, BookTypeID: 1, GenreID: 13, ConditionID: 5, Price: 10.95, Quantity: 25, Year: &year2020, CoverImageUrl: "/images/coverimages/apocalypse.png"},
		{Entity: model.Entity{ID: 2}, Name: "Children Of Iron", Author: "Nikki Wolf", ISBN: "7665438976", PublisherID: 16, BookTypeID: 1, GenreID: 11, ConditionID: 6, Price: 13.95, Quantity: 3, Year: &year2019, CoverImageUrl: "/images/coverimages/childrenofiron.png"},
		{Entity: model.Entity{ID: 3}, Name: "Gold In The Dark", Author: "Richard Roe", ISBN: "5442280765", PublisherID: 17, BookTypeID: 1, GenreID: 13, ConditionID: 5, Price: 6.50, Quantity: 10, Year: &year2018, CoverImageUrl: "/images/coverimages/goldinthedark.png"},
		{Entity: model.Entity{ID: 4}, Name: "Leagues Of Smoke", Author: "Pat Candella", ISBN: "4556789542", PublisherID: 18, BookTypeID: 2, GenreID: 11, ConditionID: 7, Price: 3.00, Quantity: 1, Year: &year2017, CoverImageUrl: "/images/coverimages/leaguesofsmoke.png"},
		{Entity: model.Entity{ID: 5}, Name: "Alone With The Stars", Author: "Carlos Salazar", ISBN: "4563358087", PublisherID: 19, BookTypeID: 2, GenreID: 12, ConditionID: 5, Price: 15.95, Quantity: 5, Year: &year2021, CoverImageUrl: "/images/coverimages/alonewiththestars.png"},
		{Entity: model.Entity{ID: 6}, Name: "The Girl In The Polaroid", Author: "Terri Whitlock", ISBN: "2354435678", PublisherID: 20, BookTypeID: 1, GenreID: 12, ConditionID: 6, Price: 8.25, Quantity: 2, Year: &year2016, CoverImageUrl: "/images/coverimages/girlinthepolaroid.png"},
		{Entity: model.Entity{ID: 7}, Name: "1001 Jokes", Author: "Mary Major", ISBN: "6554789632", PublisherID: 21, BookTypeID: 2, GenreID: 11, ConditionID: 5, Price: 13.95, Quantity: 7, Year: &year2015, CoverImageUrl: "/images/coverimages/1001jokes.png"},
		{Entity: model.Entity{ID: 8}, Name: "My Search For Meaning", Author: "Mateo Jackson", ISBN: "4558786554", PublisherID: 22, BookTypeID: 3, GenreID: 8, ConditionID: 7, Price: 5.00, Quantity: 15, Year: &year2022, CoverImageUrl: "/images/coverimages/mysearchformeaning.png"},
	}
